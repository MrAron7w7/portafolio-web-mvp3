...
<template>
    <div class="relative" ref="containerRef">
        <div class="mb-8">
            <h1 class="mb-3 text-2xl font-bold text-gray-900 dark:text-white lg:text-3xl">Educación</h1>
        ...
        <div class="space-y-3">
            ...
            <div v-for="(education, index) in modelValue" :key="education.id"
                ...
                <!-- Header del acordeón -->
                <div @click="toggleEducation(education.id)"
                        ...
                        <div class="flex flex-col">
                            <div class="flex items-center gap-2">
                                <span class="text-base font-medium transition-colors duration-300" :class="{
                                    'text-red-700 dark:text-red-400': hasEducationError(index),
                                    'text-emerald-700 dark:text-emerald-400': newItems.has(education.id),
                                    'text-gray-900 dark:text-white': !hasEducationError(index) && !newItems.has(education.id)
                                }">
                            ...
                            <span v-if="education.institution" class="text-sm text-gray-500 dark:text-slate-400">
                ...
                <transition enter-active-class="transition-all duration-300 ease-out"
                    ...
                    <div v-if="expandedIndex === education.id" class="border-t px-4 py-4 bg-white/50 dark:bg-slate-900/50"
                        :class="hasEducationError(index) ? 'border-red-200 dark:border-red-500/30' : 'border-gray-200 dark:border-slate-800'">
        ...
        <transition enter-active-class="transition-all duration-200 ease-out"
            ...
            <div v-if="deleteConfirmIndex !== null"
                ...
                <div class="relative">
                    ...
                    <h4 class="mb-1 text-center text-sm font-semibold text-gray-900 dark:text-white">
                        ¿Eliminar educación?
                    </h4>

                    <p class="mb-4 text-center text-xs text-gray-600 dark:text-slate-400">
