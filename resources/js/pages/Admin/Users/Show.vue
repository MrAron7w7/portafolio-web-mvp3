                ...
                <div class="rounded-2xl bg-white shadow-sm border border-gray-100 p-6">
                    ...
                    <div v-if="portfolios.length > 0" class="space-y-3">
                        <div
                            ...
                            :key="portfolio.id"
                            class="rounded-lg border border-gray-100 p-3 hover:bg-gray-50 transition-colors"
                        >
                            <div class="flex items-start justify-between">
                                <div>
                                    <p class="font-medium text-gray-900 text-sm">{{ portfolio.title }}</p>
                                    <p class="text-xs text-gray-500 capitalize">{{ portfolio.template_type }}</p>
                                </div>
                                <span :class="[
                                    'text-xs px-2 py-0.5 rounded-full',
                                    portfolio.is_public ? 'bg-green-100 text-green-700' : 'bg-gray-100 text-gray-600'
                                ]">
                    ...
                    <div v-else class="text-center py-8">
                        ...
                        <p class="mt-2 text-sm text-gray-500">Sin portafolios</p>
                    </div>
                </div>
            </div>
        </div>
