            ...
            <div class="space-y-4">
                <div class="pt-4 border-t border-gray-100">
                    <div class="space-y-1">
                        ...
                        <Link v-if="isAdmin" href="/admin" :class="[
                        ...
                        <!-- Notificaciones -->
                        <NotificationPanel @update:unread="unreadNotifications = $event">
                            <template #trigger>
                                <Bell class="h-5 w-5 text-gray-400 group-hover:text-gray-900" />
                                <span>Notificaciones</span>

                                <!-- Badge dinámico -->
                                <span v-if="unreadNotifications > 0" class="ml-auto flex h-5 min-w-[1.25rem] items-center justify-center rounded-full
                                bg-red-100 text-xs font-medium text-red-600 animate-pulse px-1">
                                    {{ unreadNotifications }}
                                </span>
                            </template>
                        </NotificationPanel>
                            ...
                            <DropdownMenuTrigger as-child>
                                <button
                                    ...
                                    <div class="flex items-center space-x-3">
                                        <Settings2
                                            class="h-5 w-5 text-gray-400 transition-transform duration-300 group-hover:rotate-90" />
                                        <span>Configuración</span>
                                    </div>
                                    <ChevronRight
                                        class="h-4 w-4 text-gray-400 opacity-0 group-hover:opacity-100 transition-all duration-300" />
                                </button>
                            </DropdownMenuTrigger>
